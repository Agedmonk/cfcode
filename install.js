const CURRENT_VERSION = "1.0.202609091433"; // 当前版本号，置于顶部方便随时修改
...
// ==================== Worker 部署核心 ====================
async function deployWorkerCore(accountId, apiToken, kvName, workerName, codeUrl, kvAction = 'keep', envs = []) {
  const logs = [];
